...
FileConfirmed=open('source/GlobalRecovered.csv', 'r')
...
plt.title('Global Recovered')
plt.xlabel('Days')
plt.ylabel('Recovered')
plt.legend()
plt.savefig('plt/GlobalRecovered.png',dpi=300)
plt.show()
...
plt.title('Global Recovered As Log')
plt.xlabel('Days')
plt.ylabel('Recovered')
plt.legend()
plt.semilogy()
plt.savefig('plt/GlobalRecoveredForLog.png',dpi=300)
plt.show()
